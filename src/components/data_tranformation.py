...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        try:
            ...
            logging.info("Data Transformnation Started")
    ...
    def initiate_data_transformation(self,train_path,test_path):
        ...
        try:
            ...
            target_feature_test_dasta=test_data[target_column_name]

            # Applay transformation on our train data & test data
            ...
            # Apply processor object on our Train data & test data
            train_array = np.c_[input_feature_train_arr, np.array(target_feature_train_data)]
            test_array = np.c_[input_feature_test_arr, np.array(target_feature_test_dasta)]
